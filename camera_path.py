    ...
    builders: list[tuple[str, str, str, str, Callable[[], list[CameraKeyframe]]]] = [
        ...
        (
            ...
            lambda: _dolly_keyframes(
                ...
                alt_start_m=500,
                alt_end_m=500,
                lateral_offset_start_m=-500,
                lateral_offset_end_m=500,
                look_forward=True,
        ...
        (
            ...
            lambda: _dolly_keyframes(
                ...
                alt_start_m=600,
                alt_end_m=600,
                lateral_offset_start_m=-400,
                lateral_offset_end_m=400,
                look_forward=False,
            ),
        ),
        (
            ...
            lambda: _dolly_keyframes(
                ...
                alt_start_m=700,
                alt_end_m=700,
                lateral_offset_start_m=-470,
                lateral_offset_end_m=470,
                look_forward=True,
                forward_tilt_deg=78.0,
            ),
        ),
